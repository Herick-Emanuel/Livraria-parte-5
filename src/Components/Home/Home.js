          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="mr-auto">
              ...
              <NavDropdown title="Livro" id="basic-nav-dropdown">
                ...
                <NavDropdown.Item
                  as={Link}
                  to="/home/livros/lancamento-livro"
                  className="nav-dropdown"
                >
                  Lançamentos
                </NavDropdown.Item>
                <NavDropdown.Item
                  as={Link}
                  to="/home/livros/livros-cadastrados"
                  className="nav-dropdown"
                >
                  Livros Cadastrados
                </NavDropdown.Item>
                <NavDropdown.Item
                  as={Link}
                  to="/home/livros/cadastrar-livro"
                  className="nav-dropdown"
                >
                  Cadastrar Livro
                </NavDropdown.Item>
